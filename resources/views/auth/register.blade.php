                ...
                <div class="col-md-6">
                    <div class="card shadow" style="margin-top: 100px">
                        <div class="card-header" style="background-color: silver;">
                            <h5>New here?</h5>
                            <p style="letter-spacing: 0px">Signing up is easy. It only takes a few steps</p>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Email Address') }}</label>
