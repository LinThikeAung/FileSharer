...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="#page-top">Start Sharing And Uploading</a>
        ...
        <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div class="text-center">
                    <h1 class="mx-auto my-0 text-uppercase">DKMads Sharing</h1>
                    <h2 class="text-white-50 mx-auto mt-2 mb-5">“ Knowing is not enough; we must apply. Being willing is not enough; we must do. ”</h2>
